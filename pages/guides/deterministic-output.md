...
Malarky uses a seedable random number generator (RNG). Setting a seed makes all output reproducible -- the same seed with the same configuration always produces identical text.
